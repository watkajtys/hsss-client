...
export default React.createClass({
  ...
  render: function () {
    ...
    if (this.isSplash(this.props.slide)) {
      ...
      slideType = <Audio header={this.props.slide.header} file={this.props.slide.audioFile} classExtra={this.props.slide.gender} activeSlide={this.props.activeSlide} active={this.deckIsActive(this.props.slide)} nextSlide={this.props.slide.nextSlide}/>
    } else {
